      ...
      <>
        ...
        <Image src ="/iooo.png" width={150}  height={150} alt="logo" /> 
                                    ...
                                    <div className={styles.container}> 
                                        ...
                                        <input onChange={(e) => setName(e.target.value)}  className={styles.input1} type="name"  placeholder="Name" />   
                                        <input onChange={(e) => setSurname(e.target.value)}  className={styles.input1} type="surname"  placeholder="Surname" />   
                                            </div> 
                                            </div>
                                            ...
                                            <div className={styles.frameinput2}>
                                                ...
                                                <input onChange={(e) => setEmail(e.target.value)}  className={styles.input} type="email"  placeholder="Email" /> 
                                                ...
                                                <button   type="submit"  className={styles.button}><h6 className={styles.fontsignup}>Sign up</h6></button> 
