...
<div className={styles.po}>
        <Image src ="/po.svg" width={150}  height={150} alt="logo" /> 
                                                ...
                                                <input className={styles.input1} type="text"  placeholder={user.name} />
                                                ...
                                                <input  className={styles.input} type="text"  placeholder={user.surname} />   
                                                <br></br> 
                                        ...
                                        <input className={styles.input1} type="number"  placeholder={user.day} />   
                                        <input  className={styles.input1} type="number"  placeholder={user.month} />  
                                        <input  className={styles.input1} type="number"  placeholder={user.year} />  
                                            ...
                                            <div className={styles.fip7}>
                                                ...
                                                <h5 className={styles.fontMonth}>Resident Registration Address</h5>
                                                </div> 

                                                <div className={styles.fip10}>
                                                <h5 className={styles.fontMonth}>Role</h5>
                                                </div> 
                                       <input  className={styles.input} type="text"  placeholder={user.email}/> 
                                       <br></br> 
                                       <input   className={styles.input} type="text"  placeholder={user.postalcode} /> 
                                       <br></br> 
                                       <input   className={styles.input} type="text"  placeholder={user.address} />
                                       <br></br> 
                                       <input   className={styles.input} type="text"  placeholder={user.role} />     
